...
(facts "when determining neighbours"
       ...
       (facts "for odd-q offset coordinates"
              ...
              (facts "when on an odd column"
                     ...
                     (fact "all neighbours are accessible"
                           (neighbours/neighbours_for_odd_q {:x 1 :y 0})
                           => (contains '({:x 1 :y -1}
                                           {:x 1 :y 1}
                                           {:x 2 :y -1}
                                           {:x 0 :y 0}
       ...
       (facts "for even-q offset coordinates"
              (facts "when on an even column"
                     ...
                     (fact "all neighbours are accessible"
                           (neighbours/neighbours_for_even_q {:x 0 :y 0})
                           => (contains '({:x 0 :y -1}
                                           {:x 0 :y 1}
                                           {:x 1 :y 0}
                                           {:x -1 :y 0}
              ...
              (facts "when on an odd column"
                     ...
                     (fact "all neighbours are accessible"
                           (neighbours/neighbours_for_even_q {:x 1 :y 0})
                           => (contains '({:x 1 :y -1}
                                           {:x 1 :y 1}
                                           {:x 2 :y -1}
                                           {:x 0 :y -1}
       ...
       (facts "for odd-r offset coordinates"
              (facts "when on an even row"
                     ...
                     (fact "all neighbours are accessible"
                           (neighbours/neighbours_for_odd_r {:x 0 :y 0})
                           => (contains '({:x 0 :y -1}
                                           {:x 1 :y 0}
                                           {:x 0 :y 1}
                                           {:x -1 :y 1}
              ...
              (facts "when on an odd row"
                     ...
                     (fact "all neighbours are accessible"
                           (neighbours/neighbours_for_odd_r {:x 0 :y 1})
                           => (contains '({:x 1 :y 0}
                                           {:x 1 :y 1}
                                           {:x 1 :y 2}
                                           {:x 0 :y 2}
...
(facts "for even-r offset coordinates"
       ...
       (facts "when on an odd row"
              ...
              (fact "all neighbours are accessible"
                    (neighbours/neighbours_for_even_r {:x 0 :y 1})
                    => (contains '({:x 0 :y 0}
                                    {:x 1 :y 1}
                                    {:x 0 :y 2}
                                    {:x -1 :y 2}
