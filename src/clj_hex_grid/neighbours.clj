...
(def odd_q_neighbours {even_column {:north     {:x 0 :y -1}
                                    :south     {:x 0 :y 1}
                                    :northeast {:x 1 :y -1}
                                    :northwest {:x -1 :y -1}
                                    :southeast {:x 1 :y 0}
...
(def even_q_neighbours {even_column {:north     {:x 0 :y -1}
                                     :south     {:x 0 :y 1}
                                     :northeast {:x 1 :y 0}
                                     :northwest {:x -1 :y 0}
                                     :southeast {:x 1 :y 1}
...
(def odd_r_neighbours {even_column {:northeast {:x 0 :y -1}
                                    :east      {:x 1 :y 0}
                                    :southeast {:x 0 :y 1}
                                    :southwest {:x -1 :y 1}
                                    :west      {:x -1 :y 0}
...
(def even_r_neighbours {even_column {:northeast {:x 1 :y -1}
                                     :east      {:x 1 :y 0}
                                     :southeast {:x 1 :y 1}
                                     :southwest {:x 0 :y -1}
                                     :west      {:x -1 :y 0}
