...
(defn- reset_coordinate_with_largest_diff_to_round
	...
	(cond 
	  	(x_diff_is_largest? diff_x diff_y diff_z)
	  		{	:x (- (- rounded_y) rounded_z) 
	  			:y rounded_y 
	  			:z rounded_z}
	  	(y_diff_is_largest? diff_x diff_y diff_z)
	  		{	:x rounded_x 
...
(defn- cube_round
	...
	(let [rounded_x (Math/round float_x)
		...
		(reset_coordinate_with_largest_diff_to_round diff_x diff_y diff_z rounded_x rounded_y rounded_z)		  
		))
